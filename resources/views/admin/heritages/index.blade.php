...
<div class="max-w-6xl mx-auto px-4 py-6 space-y-6" id="heritage-admin">
    ...
    <style>
        ...
        .ha-card {
            ...
            background: rgba(2, 6, 23, 0.35); /* fallback dark */
    ...
    <form method="GET"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <div class="text-[11px] mt-2" style="color: color-mix(in oklab, var(--txt-body) 55%, transparent);">
                    Picker suku akan otomatis terisi saat pulau dipilih.
                </div>
            </div>
                ...
                <div class="ha-card p-4 space-y-4">
                    ...
                    <div class="flex items-start justify-between gap-3">
                        <div>
                            ...
                            <p class="ha-sub text-xs mt-1">Tambah / lihat detail / edit / hapus item untuk kategori ini.</p>
                        </div>
                        <span class="ha-chip" style="font-size: 11px;">
                            {{ $catKey }}
                        </span>
                    </div>
                                ...
                                <div class="hi-card"
                                    ...
                                    <div class="flex items-start justify-between gap-3">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <button type="button" class="ha-btn ha-btn-soft text-xs"
                                                    data-ha-detail>
                                                Detail
                                            </button>
    ...
    <div class="hd-overlay" id="hdOverlay" aria-hidden="true">
        <div class="hd-modal" role="dialog" aria-modal="true" aria-label="Detail Warisan">
            <div class="hd-img fallback" id="hdImg">
                🏛️
            </div>
            <div class="hd-body">
                <div class="hd-top">
        ...
        (function () {
            ...
            if (islandSelect && tribeSelect) {
                ...
                islandSelect.addEventListener('change', () => {
                    ...
                    fillTribes(islandId, '');
                    // auto submit biar langsung tampil tanpa klik
                    if (form) form.submit();
                });
