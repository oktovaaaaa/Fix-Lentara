...
@section('content')
    ...
    @php
        ...
        $asmatQuiz   = $quizzesByTribe['Asmat'] ?? null;
        $amungmeQuiz = $quizzesByTribe['Amungme'] ?? null;
        $ambonQuiz   = $quizzesByTribe['Ambon'] ?? null;
    @endphp
        ...
        <div class="max-w-5xl mx-auto space-y-10">
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-6">
                ...
                <div class="inline-flex gap-2 bg-[color-mix(in_srgb,var(--bg-body)_80%,#e5e7eb_20%)] p-1.5 rounded-full">
                    <button type="button" class="tribe-tab is-active" data-tribe-tab="asmat">Asmat</button>
                    <button type="button" class="tribe-tab" data-tribe-tab="amungme">Amungme</button>
                    <button type="button" class="tribe-tab" data-tribe-tab="ambon">Ambon</button>
                </div>
            </div>
            ...
            <div class="space-y-12" id="suku-wrapper">
                ...
                <section id="about" class="space-y-3">
                    <h2 class="text-xl sm:text-2xl md:text-3xl font-semibold">Tentang Suku di Papua & Maluku</h2>
                    ...
                    <div data-tribe-panel="asmat">
                        ...
                        @if($asmatHistories->count())
                            <section class="history-section">
                                <div class="history-container">
                                    ...
                                    <p class="history-subtitle">Jejak seni ukir, hubungan dengan alam, dan ritual leluhur di tanah Asmat.</p>
                        ...
                        @else
                            <p class="history-empty">Belum ada data sejarah Asmat yang diinput dari admin.</p>
                        @endif
                    </div>
                    ...
                    <div class="hidden" data-tribe-panel="amungme">
                        ...
                        @if($amungmeHistories->count())
                            <section class="history-section">
                                <div class="history-container">
                                    ...
                                    <p class="history-subtitle">Kisah masyarakat pegunungan Papua dalam menjaga tanah dan identitas budaya mereka.</p>
                        ...
                        @else
                            <p class="history-empty">Belum ada data sejarah Amungme yang diinput dari admin.</p>
                        @endif
                    </div>
                    ...
                    <div class="hidden" data-tribe-panel="ambon">
                        ...
                        @if($ambonHistories->count())
                            <section class="history-section">
                                <div class="history-container">
                                    ...
                                    <p class="history-subtitle">Jejak panjang Ambon sebagai simpul perdagangan rempah dan pertemuan budaya.</p>
                        ...
                        @else
                            <p class="history-empty">Belum ada data sejarah Ambon yang diinput dari admin.</p>
                        @endif
                    </div>
                </section>
                ...
                <section id="stats" class="space-y-4">
                    ...
                    <div data-tribe-panel="asmat" class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm"></div>
                    <div data-tribe-panel="amungme" class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm hidden"></div>
                    <div data-tribe-panel="ambon" class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm hidden"></div>

                    <p class="text-xs sm:text-sm text-[var(--muted)]">Data statistik Papua & Maluku akan ditambahkan kemudian.</p>
                </section>
                ...
                <section id="destinations" class="space-y-4">
                    ...
                    <div data-tribe-panel="asmat" class="grid grid-cols-1 sm:grid-cols-2 gap-4"></div>
                    <div data-tribe-panel="amungme" class="grid grid-cols-1 sm:grid-cols-2 gap-4 hidden"></div>
                    <div data-tribe-panel="ambon" class="grid grid-cols-1 sm:grid-cols-2 gap-4 hidden"></div>
                </section>
                ...
                <section id="warisan" class="space-y-4">
                    ...
                    <div data-tribe-panel="asmat" class="space-y-2"></div>
                    <div data-tribe-panel="amungme" class="space-y-2 hidden"></div>
                    <div data-tribe-panel="ambon" class="space-y-2 hidden"></div>
                </section>
                ...
                <section id="quiz" class="space-y-4">
                    ...
                    <div data-tribe-panel="asmat" class="space-y-4">
                        @include('partials.quiz-section', ['quiz' => $asmatQuiz ?: $generalIslandQuiz])
                    </div>

                    <div data-tribe-panel="amungme" class="space-y-4 hidden">
                        @include('partials.quiz-section', ['quiz' => $amungmeQuiz ?: $generalIslandQuiz])
                    </div>

                    <div data-tribe-panel="ambon" class="space-y-4 hidden">
                        @include('partials.quiz-section', ['quiz' => $ambonQuiz ?: $generalIslandQuiz])
                    </div>
                </section>
