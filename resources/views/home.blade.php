        ...
        <div class="max-w-6xl mx-auto">
            ...
            <section id="stats" class="py-12">
                ...
                <style>
                    ...
                    #stats .chart-card:nth-child(1) { animation-delay: 0.4s; }
                    #stats .chart-card:nth-child(2) { animation-delay: 0.5s; }
                    #stats .chart-card:nth-child(3) { animation-delay: 0.6s; }
                    ...
                    <button type="button" class="stat-card stat-card--green text-left text-white" data-stat="population">
                        <div class="flex items-start justify-between gap-3">
                            <div class="flex-1">
                                ...
                                <div class="stat-label">Perkiraan penduduk (Nov 2025)</div>
                                <p class="mt-2 text-white/80">
                        ...
                        const detailMap = {
                            islands: {
                                ...
                                body: `
                                    ...
                                    <p class="mt-4">Data pulau Indonesia terus dimutakhirkan setiap tahun
                            ...
                            unesco: {
                                ...
                                body: `
                                    ...
                                    <p class="mt-4">Di tingkat nasional, Kementerian Pendidikan, Kebudayaan,
                            ...
                            population: {
                                ...
                                body: `
                                    ...
                                    <p class="mt-4">Perbedaan angka antara Kemendagri dan BPS wajar terjadi
                                    ...
                                    <p class="mt-3">Data ini penting untuk perencanaan kebijakan, mulai dari
            ...
            <section id="testimoni" class="py-12">
                ...
                <style>
                    ...
                    /* Dark/Light mode adjustment */
                    html[data-theme="dark"] .t-soft {
                        background: linear-gradient(145deg, #111827, #020617);
                    }

                    html[data-theme="light"] .t-soft {
                        background: linear-gradient(145deg, #ffffff, #f8fafc);
                    }
                    ...
                    html[data-theme="light"] .t-textarea {
                        background: rgba(0, 0, 0, 0.02);
                    }
                    ...
                    /* Rating Stars (click) */
                    .star-row { display: inline-flex; gap: 8px; align-items: center; }
                    .star-btn {
                    ...
                    .star-btn:hover { transform: translateY(-2px) scale(1.05); box-shadow: 0 8px 18px rgba(255, 107, 0, 0.2); }
                    .star {
                        font-size: 20px;
                        line-height: 1;
                    ...
                    .star.is-on { color: #f59e0b; transform: scale(1.1); }
                    ...
                    /* Dark/Light mode adjustment for feedback items */
                    .feedback-item {
                                    ...
                                    <div class="t-soft feedback-item">
                                        <div class="flex items-start gap-4">
                                            ...
                                            <div class="flex-1">
                                                <div class="flex items-start justify-between gap-3">
                                                    <div>
                                                        <div class="font-extrabold text-lg">{{ $t->name }}</div>
                                                ...
                                                <p class="mt-3 text-sm leading-relaxed t-muted">
                                                    {{ $t->message }}
                                                </p>
